...
namespace gloobus\gsb\console\controllers;
 ...
 *
 * @package     gloobus
 * @subpackage  gloobus\gsb\console\controllers
 * @version     1.0.0
 * @since       1.0.0
 * @author      Tamas Palecian <tamas.palecian@nucleuswebs.com>
 * @copyright   Copyright (c) 2020 Nucleus Websites SRL
 */
class MigrationController extends Controller
{
    ...
    /**
     * @var string the directory storing the migration classes. This can be either a path or alias or a directory
     */
    ...
    /**
     * @var string the name of the table for keeping the migration information
     */
    ...
    /**
     * @var boolean whatever to execute the migration in an interactive mode
     */
